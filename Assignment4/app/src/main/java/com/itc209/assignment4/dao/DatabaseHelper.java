...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String create_constraint_table = "CREATE TABLE " + ConstraintsDao.TABLE_NAME + " (" + ConstraintsDao.CALORIES_GOAL + " INTEGER, " + ConstraintsDao.FAT_GOAL + " REAL, " + ConstraintsDao.PROTEIN_GOAL + " REAL, " + ConstraintsDao.CARBOHYDRATES_GOAL + " REAL, " + ConstraintsDao.CALORIES_LIMIT + " INTEGER, " + ConstraintsDao.FAT_LIMIT + " REAL, " + ConstraintsDao.PROTEIN_LIMIT + " REAL, " + ConstraintsDao.CARBOHYDRATES_LIMIT + " REAL);";
