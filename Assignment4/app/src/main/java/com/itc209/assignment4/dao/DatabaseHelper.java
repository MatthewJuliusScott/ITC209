...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String create_intake_table = "CREATE TABLE " + IntakeDao.TABLE_NAME + " (" + IntakeDao.FOOD_NAME + " NAME, " + IntakeDao.TIME + " DATETIME, " + IntakeDao.GRAMS + " INT, PRIMARY KEY (" + IntakeDao.FOOD_NAME + ", " + IntakeDao.TIME + "));";
